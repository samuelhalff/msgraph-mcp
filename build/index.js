...
function getUserContext(req) {
    const userId = req.headers[process.env.LIBRECHAT_USER_ID_HEADER || 'x-librechat-user-id'];
    const sessionId = req.headers[process.env.LIBRECHAT_SESSION_HEADER || 'x-librechat-session'];
    if (!userId) {
...
function extractRequestContext(params) {
