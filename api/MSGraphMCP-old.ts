...
//                             if (!authHeader || !authHeader.startsWith('Bearer ')) {
//                                 // Determine the correct external URLs for OAuth endpoints
//                                 let baseUrl: string;
...
//                                 } else {
//                                     // Try to construct external URL from request headers (for proxy scenarios)
...
//                                     // If we're in a container, try to map to host
//                                     const externalHost = host.includes('msgraph-mcp') ? 'localhost:3001' : host;
//                                     baseUrl = `${proto}://${externalHost}`;
//                                 }
...
//                                     error: {
//                                         code: -32002,
//                                         message: `OAuth authentication required. Please authenticate using the OAuth endpoints.`,
//                                         oauth_endpoints: {
...
//                                 // If no valid token, provide OAuth endpoints for authentication
...
//                                     oauthEndpoints,
//                                     timestamp: new Date().toISOString(),
//                                     message: oauthEndpoints ? 'OAuth authentication required. Use the oauthEndpoints to authenticate.' : 'Authentication available'
//                                 };
